...
import 'package:psicologia_app_liid/src/shared/widgets/animatedTimer.dart';
import 'package:video_player/video_player.dart';
import 'package:firebase_auth/firebase_auth.dart';
import '../../../shared/widgets/video_service.dart';
...
class _TecnicasState extends State<Tecnicas> {
  ...
  Future<void> loadVideo() async {
    ...
    String videoPath = currentExercise["videoUrl"].toString();
  ...
  Future<void> goToNextExercise() async {
    ...
    await service.saveCompletedExercise(widget.categoryId, widget.methodId, currentExerciseIndex);
    ...
    if (currentExerciseIndex < service.exercises.length - 1) {
      ...
      homeController.goToResumenTecnica();
    }
  }
